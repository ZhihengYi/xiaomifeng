...
<title>分页浏览页面</title>
<style>
   #i{font-family:华文楷体;font-size:26;color:black}
</style>
...
<p id=i>
<jsp:getProperty name="dataBean" property="currentPage"/>/<jsp:getProperty name="dataBean" property="totalPages"/><br>
</p>
<table id=i>
<tr>
  <td>
...
<tr>
	<td></td><td></td>
  <td><form action="" id=i method=post>
  每页显示<input type=text id=i name="pageSize" value=<%=dataBean.getPageSize()%> size=2>/<jsp:getProperty name="dataBean" property="totalRecords"/>
